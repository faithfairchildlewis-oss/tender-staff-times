...
export const encouragements: string[] = [
  ...
  "You are a safe person for a child who needed one today. That is everything.",
  "When a child feels secure with you, their whole brain opens up to learn.",
  "What you teach a three-year-old today will still be wired in their brain at thirty.",
  "You are not just caring for children — you are building the architecture of who they will become.",
  "When you stay calm in a hard moment, you teach a child how to regulate their own emotions.",
  "A child who learns to name their feelings here will handle conflict better as an adult.",
  "Your eye contact, your smile, your response — these are the building blocks of a child's confidence.",
  "Every time you respond to a child's curiosity, you strengthen their brain. Every single time.",
  "Behavior is communication. Stay curious about what they are trying to say today.",
  "The child who is hardest to love in a given moment is usually the one most desperately asking to be loved.",
  "God gave children behavior before words. He trusted someone to interpret it with patience and grace. That someone is you.",
  "One consistent, caring adult can buffer a child from almost anything hard at home. You might be that person.",
  "Resilience is not something children are born with — it is built through relationships. You are building it.",
  "Every word you speak to a child today adds to the foundation that shapes their future.",
  "Reading aloud to a child is one of the highest-impact things a human being can do for another. You do it every day.",
  "A child who knows they belong somewhere learns better, behaves better, and loves better.",
  "When a child acts out, they are not giving you a hard time — they are having a hard time.",
  "Play is not a break from learning. Play is how children learn. You understand that better than most.",
  "You may never know the full weight of what you carry a child through. Trust that it matters.",
  "You are helping these children answer the earliest question every human asks — am I worthy of love?",
];
