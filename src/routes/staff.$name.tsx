      ...
      >
        <div className="flex gap-2">
          <Link
            ...
            className="flex-1 min-h-11 px-2 rounded-lg text-xs font-semibold inline-flex items-center justify-center gap-1.5 bg-primary-foreground text-primary"
          >
          ...
          <Link
            to="/rooms"
            search={{ from: name }}
            className="flex-1 min-h-11 px-2 rounded-lg text-xs font-semibold inline-flex items-center justify-center gap-1.5 bg-primary-foreground/15 text-primary-foreground"
          >
